...
function Project({ data }: { data: ProjectProps }) {
    return (
        <div className='flex flex-col bg-zinc-800 rounded-xl pb-4 justify-center'>
            <div className='w-full h-full overflow-hidden flex justify-center items-center'>
                <img className='w-full max-h-full object-cover rounded-xl' src={data.projectImgUrl} alt="" />
            </div>
